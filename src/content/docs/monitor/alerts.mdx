...
Onax includes pre-built alert rules for Prometheus AlertManager. Copy these into your AlertManager configuration to get notified about CronJob failures, missed schedules, and performance issues.
