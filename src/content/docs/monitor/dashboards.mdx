...
Onax includes a Grafana dashboard that gives you a complete view of every CronJob in your cluster.

## Import Instructions

1. Open Grafana in your browser
2. Go to **Dashboards** → **Import**
3. Paste the dashboard JSON from the [GitHub repo](https://github.com/varaxlabs/onax/tree/main/dashboards) or enter the dashboard ID
...
- Prometheus data source configured and scraping the Onax metrics endpoint
