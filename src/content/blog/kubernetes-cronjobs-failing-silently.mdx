...
[Varax Monitor](/monitor) was built specifically for this problem. One Helm command gives you:
...
[Get started with Varax Monitor](/docs/monitor/quickstart) — it takes 60 seconds.
