...
In this post, we'll show you how to get complete CronJob observability in your cluster in under 60 seconds using [Onax](https://github.com/varaxlabs/onax), a free, open-source tool that automatically discovers and monitors every CronJob.
...
Onax handles all of this automatically:
...
Onax exports these metrics for every CronJob in your cluster:
...
Onax is designed to be invisible in your cluster:
...
Full installation guide: [Onax Quickstart](/docs/monitor/quickstart)

GitHub: [github.com/varaxlabs/onax](https://github.com/varaxlabs/onax)
